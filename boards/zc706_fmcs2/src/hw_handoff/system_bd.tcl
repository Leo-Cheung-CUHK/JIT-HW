...
proc create_hier_cell_openwifi_ip { parentCell nameHier } {
  ...
  connect_bd_net -net openofdm_rx_0_legacy_sig_stb [get_bd_pins openofdm_rx_0/legacy_sig_stb] [get_bd_pins xpu_0/legacy_sig_stb]
  connect_bd_net -net openofdm_rx_0_long_preamble_detected [get_bd_pins openofdm_rx_0/long_preamble_detected] [get_bd_pins xpu_0/long_preamble_detected]
  ...
  connect_bd_net -net openofdm_rx_0_short_preamble_detected [get_bd_pins openofdm_rx_0/short_preamble_detected] [get_bd_pins xpu_0/short_preamble_detected]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ROM_ADDR_BITS {5} \
 ] $axi_sysid_0

  # Create instance: blk_mem_gen_0, and set properties
  set blk_mem_gen_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 blk_mem_gen_0 ]
  set_property -dict [ list \
   CONFIG.Coe_File {../../../openwifi_rev.coe} \
  ...
  # Create port connections
  connect_bd_net -net GND_1_dout [get_bd_pins GND_1/dout] [get_bd_pins sys_concat_intc/In0] [get_bd_pins sys_concat_intc/In8] [get_bd_pins sys_concat_intc/In9] [get_bd_pins sys_concat_intc/In10] [get_bd_pins sys_concat_intc/In11]
  ...
  connect_bd_net -net axi_sysid_0_rom_addr [get_bd_pins axi_sysid_0/rom_addr] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins axi_sysid_0/sys_rom_data] [get_bd_pins blk_mem_gen_0/douta]
  connect_bd_net -net dac_ready_1 [get_bd_pins openwifi_ip/dac_ready] [get_bd_pins util_ad9361_dac_upack/s_axis_ready]
  connect_bd_net -net dma_data_1 [get_bd_pins axi_ad9361_dac_dma/m_axis_data] [get_bd_pins openwifi_ip/dma_data]
  connect_bd_net -net dma_valid_1 [get_bd_pins axi_ad9361_dac_dma/m_axis_valid] [get_bd_pins openwifi_ip/dma_valid]
  ...
  connect_bd_net -net sys_ps7_FCLK_RESET2_N [get_bd_pins openwifi_ip/ext_reset_in] [get_bd_pins sys_ps7/FCLK_RESET2_N]
  ...
  create_bd_addr_seg -range 0x02000000 -offset 0xFC000000 [get_bd_addr_spaces openwifi_ip/axi_dma_1/Data_SG] [get_bd_addr_segs sys_ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_sys_ps7_ACP_QSPI_LINEAR
  create_bd_addr_seg -range 0x02000000 -offset 0xFC000000 [get_bd_addr_spaces openwifi_ip/axi_dma_1/Data_MM2S] [get_bd_addr_segs sys_ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_sys_ps7_ACP_QSPI_LINEAR
  create_bd_addr_seg -range 0x02000000 -offset 0xFC000000 [get_bd_addr_spaces openwifi_ip/axi_dma_1/Data_S2MM] [get_bd_addr_segs sys_ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_sys_ps7_ACP_QSPI_LINEAR
